...
func (*Store) Descriptor() ([]byte, []int) {
	return file_earbug_v5_store_proto_rawDescGZIP(), []int{0}
}
...
func (*UserData) Descriptor() ([]byte, []int) {
	return file_earbug_v5_store_proto_rawDescGZIP(), []int{1}
}
...
func (*Playback) Descriptor() ([]byte, []int) {
	return file_earbug_v5_store_proto_rawDescGZIP(), []int{2}
}
...
func (*Track) Descriptor() ([]byte, []int) {
	return file_earbug_v5_store_proto_rawDescGZIP(), []int{3}
}
...
func (*AudioFeatures) Descriptor() ([]byte, []int) {
	return file_earbug_v5_store_proto_rawDescGZIP(), []int{4}
}
...
func (*Artist) Descriptor() ([]byte, []int) {
	return file_earbug_v5_store_proto_rawDescGZIP(), []int{5}
}
...
var (
	file_earbug_v5_store_proto_rawDescOnce sync.Once
	file_earbug_v5_store_proto_rawDescData = file_earbug_v5_store_proto_rawDesc
)

func file_earbug_v5_store_proto_rawDescGZIP() []byte {
	file_earbug_v5_store_proto_rawDescOnce.Do(func() {
		file_earbug_v5_store_proto_rawDescData = protoimpl.X.CompressGZIP(file_earbug_v5_store_proto_rawDescData)
	})
	return file_earbug_v5_store_proto_rawDescData
}
