...
type Store struct {
	...
	xxx_hidden_Tracks map[string]*Track      `protobuf:"bytes,4,rep,name=tracks" json:"tracks,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	xxx_hidden_Users  map[int64]*UserData    `protobuf:"bytes,8,rep,name=users" json:"users,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type UserData struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Token       []byte                 `protobuf:"bytes,1,opt,name=token" json:"token,omitempty"`
	xxx_hidden_Playbacks   map[string]*Playback   `protobuf:"bytes,2,rep,name=playbacks" json:"playbacks,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Playback struct {
	...
	xxx_hidden_TrackUri    *string                `protobuf:"bytes,2,opt,name=track_uri,json=trackUri" json:"track_uri,omitempty"`
	xxx_hidden_ContextType *string                `protobuf:"bytes,3,opt,name=context_type,json=contextType" json:"context_type,omitempty"`
	xxx_hidden_ContextUri  *string                `protobuf:"bytes,4,opt,name=context_uri,json=contextUri" json:"context_uri,omitempty"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type Track struct {
	...
	xxx_hidden_Uri         *string                `protobuf:"bytes,2,opt,name=uri" json:"uri,omitempty"`
	...
	xxx_hidden_Duration    *durationpb.Duration   `protobuf:"bytes,5,opt,name=duration" json:"duration,omitempty"`
	xxx_hidden_Artists     *[]*Artist             `protobuf:"bytes,6,rep,name=artists" json:"artists,omitempty"`
	xxx_hidden_Features    *AudioFeatures         `protobuf:"bytes,7,opt,name=features" json:"features,omitempty"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type AudioFeatures struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Acousticness     float32                `protobuf:"fixed32,1,opt,name=acousticness" json:"acousticness,omitempty"`
	xxx_hidden_Danceability     float32                `protobuf:"fixed32,2,opt,name=danceability" json:"danceability,omitempty"`
	xxx_hidden_Energy           float32                `protobuf:"fixed32,3,opt,name=energy" json:"energy,omitempty"`
	xxx_hidden_Instrumentalness float32                `protobuf:"fixed32,4,opt,name=instrumentalness" json:"instrumentalness,omitempty"`
	xxx_hidden_Key              int32                  `protobuf:"varint,5,opt,name=key" json:"key,omitempty"`
	xxx_hidden_Liveness         float32                `protobuf:"fixed32,6,opt,name=liveness" json:"liveness,omitempty"`
	xxx_hidden_Loudness         float32                `protobuf:"fixed32,7,opt,name=loudness" json:"loudness,omitempty"`
	xxx_hidden_Mode             int32                  `protobuf:"varint,8,opt,name=mode" json:"mode,omitempty"`
	xxx_hidden_Speechiness      float32                `protobuf:"fixed32,9,opt,name=speechiness" json:"speechiness,omitempty"`
	xxx_hidden_Tempo            float32                `protobuf:"fixed32,10,opt,name=tempo" json:"tempo,omitempty"`
	xxx_hidden_TimeSignature    int32                  `protobuf:"varint,11,opt,name=time_signature,json=timeSignature" json:"time_signature,omitempty"`
	xxx_hidden_Valence          float32                `protobuf:"fixed32,12,opt,name=valence" json:"valence,omitempty"`
	XXX_raceDetectHookData      protoimpl.RaceDetectHookData
	XXX_presence                [1]uint32
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
...
var file_earbug_v5_store_proto_rawDesc = []byte{
...
func file_earbug_v5_store_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_earbug_v5_store_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_earbug_v5_store_proto_rawDesc = nil
