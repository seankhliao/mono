...
var file_cmd_earbug_earbugv4_store_proto_goTypes = []any{
...
func file_cmd_earbug_earbugv4_store_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cmd_earbug_earbugv4_store_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Store); i {
			case 0:
				return &v.state
			case 1:
		...
		file_cmd_earbug_earbugv4_store_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Auth); i {
			case 0:
				return &v.state
			case 1:
		...
		file_cmd_earbug_earbugv4_store_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_cmd_earbug_earbugv4_store_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Track); i {
			case 0:
				return &v.state
			case 1:
		...
		file_cmd_earbug_earbugv4_store_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Artist); i {
			case 0:
				return &v.state
			case 1:
