	...
	spec: {
						...
						properties: {
							bootstrap: {
								...
								properties: {
									type: {
										default:     "Replace"
										description: "Type is the type of the bootstrap configuration, it should be either Replace or Merge. If unspecified, it defaults to Replace."
		...
		"""
							...
							shutdown: {
								...
								properties: {
									drainTimeout: {
										description: "DrainTimeout defines the graceful drain timeout. This should be less than the pod's terminationGracePeriodSeconds. If unspecified, defaults to 600 seconds."

										type: "string"
									}
									minDrainDuration: {
										description: "MinDrainDuration defines the minimum drain duration allowing time for endpoint deprogramming to complete. If unspecified, defaults to 5 seconds."
								...
								properties: {
									...
									tracing: {
										...
										properties: {
											...
											provider: {
												description: "Provider defines the tracing provider. Only OpenTelemetry is supported currently."
												...
												properties: {
													...
													type: {
														default:     "OpenTelemetry"
														description: "Type defines the tracing provider type. EG currently only supports OpenTelemetry."
