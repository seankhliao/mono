...
k8s: apps: v1: DaemonSet: "kube-system": "cilium": {
	metadata: {
		labels: {
		...
		annotations: {
			"config.kubernetes.io/depends-on": strings.Join([
				...
				"rbac.authorization.k8s.io/ClusterRoleBinding/cilium",
				"rbac.authorization.k8s.io/namespaces/kube-system/RoleBinding/cilium-config-agent",
				"rbac.authorization.k8s.io/namespaces/cilium-secrets/RoleBinding/cilium-gateway-secrets",
