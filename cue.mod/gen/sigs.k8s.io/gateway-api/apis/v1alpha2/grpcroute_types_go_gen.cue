...
#GRPCRouteSpec: {
	...
	hostnames?: [...v1.#Hostname] @go(Hostnames,[]v1.Hostname)
...
#GRPCHeaderMatch: {
	...
	// +optional
	// +kubebuilder:default=Exact
	type?: null | v1.#HeaderMatchType @go(Type,*v1.HeaderMatchType)
...
#GRPCRouteFilter: {
	...
	//
	// +optional
	requestHeaderModifier?: null | v1.#HTTPHeaderFilter @go(RequestHeaderModifier,*v1.HTTPHeaderFilter)
	...
	//
	// +optional
	responseHeaderModifier?: null | v1.#HTTPHeaderFilter @go(ResponseHeaderModifier,*v1.HTTPHeaderFilter)
	...
	//
	// +optional
	requestMirror?: null | v1.#HTTPRequestMirrorFilter @go(RequestMirror,*v1.HTTPRequestMirrorFilter)
	...
	// +optional
	extensionRef?: null | v1.#LocalObjectReference @go(ExtensionRef,*v1.LocalObjectReference)
}
